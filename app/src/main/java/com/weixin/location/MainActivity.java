...
import com.weixin.location.permissions.PermissionsActivity;
import com.weixin.location.permissions.PermissionsChecker;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_CODE = 0;  //定位需要的动态权限
